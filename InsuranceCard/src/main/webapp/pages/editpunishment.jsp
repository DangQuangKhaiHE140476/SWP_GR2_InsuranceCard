                ...
                <div class="container-fluid row">
                    ...
                    <div class="col-lg-8">
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                <form class="form-horizontal" role="form" action="edit_punishment_function">
                                    <%Punishment p = (Punishment)request.getAttribute("punishment"); %>
                                    ...
                                    <div class="form-group row py-3">
                                        ...
                                        <div class="col-lg-10">
                                            <input type="number" class="form-control" name="id" value="<%=p.getId()%>" readonly>
                                        </div>
                                    </div>
                                    <div class="form-group row py-3">
                                        <label for="amount" class="col-lg-2 control-label">Amount</label>
                                        <div class="col-lg-10">
                                            <input type="number" class="form-control" name="amount" value="<%=p.getAmount()%>">
                                        </div>
                                    </div>
                                    <div class="form-group row py-3">
                                        <label for="reason" class="col-lg-2 control-label">Reason</label>
                                        <div class="col-lg-10">
                                            <textarea class="form-control" name="reason" rows="5"><%=p.getReason() %></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group row py-3">
                                        <label for="deadline" class="col-lg-2 control-label">Deadline</label>
                                        <div class="col-lg-10">
                                            <input type="datetime-local" class="form-control" name="deadline" value="<%=p.getDeadline().toLocalDateTime()%>">
                                        </div>
                                    </div>
                                    <div class="form-group row py-3">
                                        <label for="status" class="col-lg-2 control-label">Status</label>
                                        <div class="col-lg-10">
                                            <input type="number" class="form-control" name="status" placeholder="<%=p.getPunishmentStatus().getStatus()%>" disabled>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-offset-2 col-lg-6 py-2">
                                            <button type="submit" class="btn btn-primary btn-lg btn-block">Update punishment</button>
                                        </div>
                                        <div class="col-lg-offset-2 col-lg-6 py-2">
